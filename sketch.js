...
function preload() {
  bgI = loadImage("bg sky.png")

  bgLandI = loadImage("grave.png")

  groundI = loadImage("ground.png");

  skeletonI = loadAnimation("1.png", "2.png", "3.png", "4.png", "5.png", "6.png", "7.png");

  pitI = loadImage("pit1.png");

  skeletonJump = loadAnimation("jump.png");

  skeletonDead = loadAnimation("death.png");

  fireI = loadAnimation("fire1.png", "fire2.png", "fire3.png", "fire4.png", "fire5.png");

  ghostI = loadAnimation("ghost1.png", "ghost2.png", "ghost3.png ", "ghost4.png");

  graveStoneI = loadImage("graveStone.png");

  font = loadFont("IndieFlower-Regular.ttf");
  mainMenuI = loadImage("main menu.png");
  controlIconI = loadImage("control icon.png");
  playI = loadImage("play.png");
  controlsI = loadImage("controls.png");
  backI = loadImage("back.png");
  homeI = loadImage("home.png");
  restartI = loadImage("reset.png");
